  ...
  return (
    <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center min-h-screen px-6 py-12 lg:py-0 bg-white">
      ...
      <div id="features" className="flex-1 text-left lg:h-[800px] flex flex-col justify-center lg:mr-12 lg:order-1">
        <h3 className="uppercase mb-4 text-sm tracking-wide text-neutral-600">Всё, что нужно — под рукой</h3>
        <p className="text-2xl lg:text-4xl mb-8 text-neutral-900 leading-tight">
          Мини-приложение работает прямо внутри Telegram. Никаких загрузок и регистраций — открываешь и сразу пользуешься.
        </p>
        <a
          href="https://t.me"
